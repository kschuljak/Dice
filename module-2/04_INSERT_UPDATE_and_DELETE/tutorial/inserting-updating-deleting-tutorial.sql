...
WHERE c.last_name = 'Mamwell' 
	AND c.first_name = 'Elenore'
...
VALUES
(50
 	, (SELECT size_id FROM size WHERE size_description = 'Large')
	, 'Thin'
	, 'Normal'
	, 17.24
)
...
price = price + 2 WHERE pizza_id = 67;


-- Part four: Remove additional pizza

-- first delete topping from pizza-topping table because it has a foreign key constriant of pizza.pizza_id
