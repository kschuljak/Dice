...
public class ExceptionsLecture
{
    ...
    public static void main(String[] args)
    {
        ...
        { // If a NumberFormatException is thrown by Integer.valueOf(...) it will be caught here since NumberFormatException "is-a" Exception
    ...
    private static void doSomethingDangerous()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            numbers[i] = i;  // this line will throw an Exception once it reaches 5
        }
